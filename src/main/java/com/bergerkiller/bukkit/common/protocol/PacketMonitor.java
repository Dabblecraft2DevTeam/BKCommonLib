...
/**
 * Allows a plugin to monitor the packets being received and sent, but not alter
 * the outcome
 */
public interface PacketMonitor {

    /**
     * Called when a packet is going to be sent to a player. This method does
     * not allow the packet to be altered - use a {@link PacketListener} for
     * that!
     *
     ...
     * This method does not allow the packet to be altered - use a
     * {@link PacketListener} for that!
     *
