...
public class LongHashSet extends BasicWrapper implements Iterable<Long> {
    ...
    public boolean add(int msw, int lsw) {
        return ((org.bukkit.craftbukkit.v1_10_R1.util.LongHashSet) handle).add(msw, lsw);
    }

    public boolean add(long value) {
        return ((org.bukkit.craftbukkit.v1_10_R1.util.LongHashSet) handle).add(value);
    }

    public boolean contains(int msw, int lsw) {
        return ((org.bukkit.craftbukkit.v1_10_R1.util.LongHashSet) handle).contains(msw, lsw);
    }

    public boolean contains(long value) {
        return ((org.bukkit.craftbukkit.v1_10_R1.util.LongHashSet) handle).contains(value);
    }
    ...
    public long popFirst() {
        return ((org.bukkit.craftbukkit.v1_10_R1.util.LongHashSet) handle).popFirst();
    }
     ...
     */
    public int size() {
        return Math.max(((org.bukkit.craftbukkit.v1_10_R1.util.LongHashSet) handle).size(), 0);
    }
